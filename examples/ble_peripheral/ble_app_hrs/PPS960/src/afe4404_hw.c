...
//=============================================================================================
#ifdef LIFEQ
					if(1== skin)//&& 1==green_led_on_flag)// skin detect control add data to algorithm
...
uint32_t threshold_high=1200;   // high value - low value >32768/100+1
uint32_t threshold_low =700;
uint8_t is_skin=0;
...
void PPS_Gled_on_by_skin_etect(uint8_t onSkin)
{
        ...
        {
                AFE4404_setLedCurrent(1,55);// Green  //DEFAULT_GREEN_CURRENT=55
                GledOn=2;
								green_led_on_flag=1;
        }
