...
//uint8_t ADJUSTMENTTIMEOUTLIMIT = 25;
//uint8_t SAMPLESTOREEVALUATE = 50;
...
void AGC_InitializeAGC(void)
{
	...
	AFE4404_setLedCurrent(1,55);// Green LED current
	AFE4404_setLedCurrent(2,9);// IR ,12->9
	...
	AGCStruct.AGCCont_Amp = TRUE;//cole modify for skin detect stable,default RF=500K;
	AGCStruct.AGCCont_UnableToIncreaseAmp = FALSE;

	AGCStruct.AGCCont_LEDCur[0] = TRUE;
	AGCStruct.AGCCont_LEDCur[1] = TRUE;
