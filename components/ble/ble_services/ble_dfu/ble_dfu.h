...
#define BLE_DFU_SERVICE_UUID                 0xFF40                       /**< The UUID of the DFU Service. */
#define BLE_DFU_PKT_CHAR_UUID                0xFF42                       /**< The UUID of the DFU Packet Characteristic. */
#define BLE_DFU_CTRL_PT_UUID                 0xFF41                       /**< The UUID of the DFU Control Point. */
#define BLE_DFU_STATUS_REP_UUID              0xFF43                       /**< The UUID of the DFU Status Report Characteristic. */
#define BLE_DFU_REV_CHAR_UUID                0xFF44                       /**< The UUID of the DFU Revision Characteristic. */
