...
typedef enum
{
    ...
    BLE_ADV_EVT_CONNECTED,
    BLE_ADV_EVT_WITH_WHITELIST,
    BLE_ADV_EVT_WITH_WHITELIST_SLOW,
	  BLE_ADV_EVT_WITHOUT_WHITELIST,
 ...
 */
void ble_advertising_restart_without_whitelist(void);
/** @} */
